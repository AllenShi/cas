...
public class DefaultCentralAuthenticationService extends AbstractCentralAuthenticationService {
    ...
    public ServiceTicket grantServiceTicket(final String ticketGrantingTicketId, final Service service, final AuthenticationResult authenticationResult, final boolean fromImpersonation)
        ...
        RegisteredServiceAccessStrategyUtils.ensurePrincipalAccessIsAllowedForService(selectedService, registeredService, ticketGrantingTicket,fromImpersonation);
    ...
    public Assertion validateServiceTicket(final String serviceTicketId, final Service service) throws AbstractTicketException {
        ...
        try {
            ...
            if(!registeredService.getClass().getSimpleName().startsWith("Oidc")) {
                attributesToRelease = attributePolicy != null
                        ? attributePolicy.getAttributes(principal, selectedService, registeredService) : new HashMap<>();
            } else {
                attributesToRelease = principal.getAttributes();
           }
           */
