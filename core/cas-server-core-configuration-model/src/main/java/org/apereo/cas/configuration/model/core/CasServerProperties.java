...
public class CasServerProperties implements Serializable {
    ...
    public void setImpersonateFile(final String impersonateFile) {
        this.impersonateFile = impersonateFile;
    }

    public String getImpersonateFile() {
        return impersonateFile;
    }

    public boolean getJaasCheck() {
        return jaasCheck;
    }
