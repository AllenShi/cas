 ...
 * @since 4.0.0
 */
public abstract class AbstractAuthenticationHandler implements AuthenticationHandler, Comparable<AuthenticationHandler> {
    ...
    @Override
    public int compareTo(AuthenticationHandler handler) {
        return Integer.compare(this.order,handler.getOrder());
    }
}
